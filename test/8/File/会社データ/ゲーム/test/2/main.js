...
window.onload = function(){
	...
	game.fps = 30;
	game.preload('chara1.png', 'chara2.png', 'icon0.png', 'bigmonster1.gif','effect0.png');
	game.onload = function() {
		...
		bear5.addEventListener('enterframe', function(e){ //イベントリスナーを追加する		 	
			...
			enemy.frame = [6];
							...
							// 爆発処理
							new bomb = new Sprite(16, 16);
							bomb.fram = [1,2,3,4];
							bomb.image = game.assets['effect0.png'];
							bomb.x = bomb.y = 100;　// 初期位置
							second.addChild(bomb);
