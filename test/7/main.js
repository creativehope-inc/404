...
*/
	...
	// #####################################
		// ゲーム
	var setting = window.game.setting,
		...
		// シーン
		SuperLabel= window.labels.SuperLabel,
		bg1= window.labels.bg1,
		welcomeMessage= window.labels.welcomeMessage,
		hitpointCounter= window.labels.hitpointCounter,
		speedCounter= window.labels.speedCounter,
		pointCounter= window.labels.pointCounter,
		timeCounter= window.labels.timeCounter,
		gameOverMessage= window.labels.gameOverMessage;
